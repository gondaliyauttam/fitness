...
class WodMini extends StatefulWidget {
  const WodMini({Key? key}) : super(key: key);

  @override
  _WodMiniState createState() => _WodMiniState();
}

class _WodMiniState extends State<WodMini> {

...
class MobilityCategories extends StatefulWidget {
  const MobilityCategories({Key? key}) : super(key: key);

  @override
  _MobilityCategoriesState createState() => _MobilityCategoriesState();
}

class _MobilityCategoriesState extends State<MobilityCategories> {
  String? id;
  List mobCatList = [];
      ...
      child: Scaffold(
        ...
        body: StaggeredGridView.countBuilder(
          ...
          staggeredTileBuilder: (int index) =>
              StaggeredTile.count(1, index.isEven ? 2 : 1.75),
          mainAxisSpacing: 4.0,

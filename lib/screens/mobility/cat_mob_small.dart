...
class MobilityCatSmall extends StatefulWidget {
  const MobilityCatSmall({Key? key}) : super(key: key);

  @override
  _MobilityCatSmallState createState() => _MobilityCatSmallState();
}

class _MobilityCatSmallState extends State<MobilityCatSmall> {
  String? id;
  List mobCatList = [];
